...
void Sbar_LoadPics (void)
{
	...
	for (i = 0; i < 10; i++)
	{
		sb_nums[0][i] = Draw_PicFromWad (va ("num_%i", i), true);
		sb_nums[1][i] = Draw_PicFromWad (va ("anum_%i", i), true);
	}

	sb_nums[0][10] = Draw_PicFromWad ("num_minus", true);
	sb_nums[1][10] = Draw_PicFromWad ("anum_minus", true);

	sb_colon = Draw_PicFromWad ("num_colon", true);
	sb_slash = Draw_PicFromWad ("num_slash", true);

	sb_weapons[0][0] = Draw_PicFromWad ("inv_shotgun", true);
	sb_weapons[0][1] = Draw_PicFromWad ("inv_sshotgun", true);
	sb_weapons[0][2] = Draw_PicFromWad ("inv_nailgun", true);
	sb_weapons[0][3] = Draw_PicFromWad ("inv_snailgun", true);
	sb_weapons[0][4] = Draw_PicFromWad ("inv_rlaunch", true);
	sb_weapons[0][5] = Draw_PicFromWad ("inv_srlaunch", true);
	sb_weapons[0][6] = Draw_PicFromWad ("inv_lightng", true);

	sb_weapons[1][0] = Draw_PicFromWad ("inv2_shotgun", true);
	sb_weapons[1][1] = Draw_PicFromWad ("inv2_sshotgun", true);
	sb_weapons[1][2] = Draw_PicFromWad ("inv2_nailgun", true);
	sb_weapons[1][3] = Draw_PicFromWad ("inv2_snailgun", true);
	sb_weapons[1][4] = Draw_PicFromWad ("inv2_rlaunch", true);
	sb_weapons[1][5] = Draw_PicFromWad ("inv2_srlaunch", true);
	sb_weapons[1][6] = Draw_PicFromWad ("inv2_lightng", true);

	for (i = 0; i < 5; i++)
	{
		sb_weapons[2 + i][0] = Draw_PicFromWad (va ("inva%i_shotgun", i + 1), true);
		sb_weapons[2 + i][1] = Draw_PicFromWad (va ("inva%i_sshotgun", i + 1), true);
		sb_weapons[2 + i][2] = Draw_PicFromWad (va ("inva%i_nailgun", i + 1), true);
		sb_weapons[2 + i][3] = Draw_PicFromWad (va ("inva%i_snailgun", i + 1), true);
		sb_weapons[2 + i][4] = Draw_PicFromWad (va ("inva%i_rlaunch", i + 1), true);
		sb_weapons[2 + i][5] = Draw_PicFromWad (va ("inva%i_srlaunch", i + 1), true);
		sb_weapons[2 + i][6] = Draw_PicFromWad (va ("inva%i_lightng", i + 1), true);
	}

	sb_ammo[0] = Draw_PicFromWad ("sb_shells", true);
	sb_ammo[1] = Draw_PicFromWad ("sb_nails", true);
	sb_ammo[2] = Draw_PicFromWad ("sb_rocket", true);
	sb_ammo[3] = Draw_PicFromWad ("sb_cells", true);

	sb_armor[0] = Draw_PicFromWad ("sb_armor1", true);
	sb_armor[1] = Draw_PicFromWad ("sb_armor2", true);
	sb_armor[2] = Draw_PicFromWad ("sb_armor3", true);

	sb_items[0] = Draw_PicFromWad ("sb_key1", true);
	sb_items[1] = Draw_PicFromWad ("sb_key2", true);
	sb_items[2] = Draw_PicFromWad ("sb_invis", true);
	sb_items[3] = Draw_PicFromWad ("sb_invuln", true);
	sb_items[4] = Draw_PicFromWad ("sb_suit", true);
	sb_items[5] = Draw_PicFromWad ("sb_quad", true);

	sb_sigil[0] = Draw_PicFromWad ("sb_sigil1", true);
	sb_sigil[1] = Draw_PicFromWad ("sb_sigil2", true);
	sb_sigil[2] = Draw_PicFromWad ("sb_sigil3", true);
	sb_sigil[3] = Draw_PicFromWad ("sb_sigil4", true);

	sb_faces[4][0] = Draw_PicFromWad ("face1", true);
	sb_faces[4][1] = Draw_PicFromWad ("face_p1", true);
	sb_faces[3][0] = Draw_PicFromWad ("face2", true);
	sb_faces[3][1] = Draw_PicFromWad ("face_p2", true);
	sb_faces[2][0] = Draw_PicFromWad ("face3", true);
	sb_faces[2][1] = Draw_PicFromWad ("face_p3", true);
	sb_faces[1][0] = Draw_PicFromWad ("face4", true);
	sb_faces[1][1] = Draw_PicFromWad ("face_p4", true);
	sb_faces[0][0] = Draw_PicFromWad ("face5", true);
	sb_faces[0][1] = Draw_PicFromWad ("face_p5", true);

	sb_face_invis = Draw_PicFromWad ("face_invis", true);
	sb_face_invuln = Draw_PicFromWad ("face_invul2", true);
	sb_face_invis_invuln = Draw_PicFromWad ("face_inv2", true);
	sb_face_quad = Draw_PicFromWad ("face_quad", true);

	sb_sbar = Draw_PicFromWad ("sbar", true);
	sb_ibar = Draw_PicFromWad ("ibar", true);
	sb_scorebar = Draw_PicFromWad ("scorebar", true);

	// MED 01/04/97 added new hipnotic weapons
	if (hipnotic)
	{
		hsb_weapons[0][0] = Draw_PicFromWad ("inv_laser", true);
		hsb_weapons[0][1] = Draw_PicFromWad ("inv_mjolnir", true);
		hsb_weapons[0][2] = Draw_PicFromWad ("inv_gren_prox", true);
		hsb_weapons[0][3] = Draw_PicFromWad ("inv_prox_gren", true);
		hsb_weapons[0][4] = Draw_PicFromWad ("inv_prox", true);

		hsb_weapons[1][0] = Draw_PicFromWad ("inv2_laser", true);
		hsb_weapons[1][1] = Draw_PicFromWad ("inv2_mjolnir", true);
		hsb_weapons[1][2] = Draw_PicFromWad ("inv2_gren_prox", true);
		hsb_weapons[1][3] = Draw_PicFromWad ("inv2_prox_gren", true);
		hsb_weapons[1][4] = Draw_PicFromWad ("inv2_prox", true);

		for (i = 0; i < 5; i++)
		{
			hsb_weapons[2 + i][0] = Draw_PicFromWad (va ("inva%i_laser", i + 1), true);
			hsb_weapons[2 + i][1] = Draw_PicFromWad (va ("inva%i_mjolnir", i + 1), true);
			hsb_weapons[2 + i][2] = Draw_PicFromWad (va ("inva%i_gren_prox", i + 1), true);
			hsb_weapons[2 + i][3] = Draw_PicFromWad (va ("inva%i_prox_gren", i + 1), true);
			hsb_weapons[2 + i][4] = Draw_PicFromWad (va ("inva%i_prox", i + 1), true);
		}

		hsb_items[0] = Draw_PicFromWad ("sb_wsuit", true);
		hsb_items[1] = Draw_PicFromWad ("sb_eshld", true);
	}

	if (rogue)
	{
		rsb_invbar[0] = Draw_PicFromWad ("r_invbar1", true);
		rsb_invbar[1] = Draw_PicFromWad ("r_invbar2", true);

		rsb_weapons[0] = Draw_PicFromWad ("r_lava", true);
		rsb_weapons[1] = Draw_PicFromWad ("r_superlava", true);
		rsb_weapons[2] = Draw_PicFromWad ("r_gren", true);
		rsb_weapons[3] = Draw_PicFromWad ("r_multirock", true);
		rsb_weapons[4] = Draw_PicFromWad ("r_plasma", true);

		rsb_items[0] = Draw_PicFromWad ("r_shield1", true);
		rsb_items[1] = Draw_PicFromWad ("r_agrav1", true);

		// PGM 01/19/97 - team color border
		rsb_teambord = Draw_PicFromWad ("r_teambord", true);
		// PGM 01/19/97 - team color border

		rsb_ammo[0] = Draw_PicFromWad ("r_ammolava", true);
		rsb_ammo[1] = Draw_PicFromWad ("r_ammomulti", true);
		rsb_ammo[2] = Draw_PicFromWad ("r_ammoplasma", true);
	}
}
